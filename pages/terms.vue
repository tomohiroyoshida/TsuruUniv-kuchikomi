  ...
  <v-container id="terms" class="pa-3">
    <v-row no-gutters justify="center" class="mt-15">
      ...
      <v-col cols="10">
        ...
        宗教活動または宗教団体への勧誘行為 その他、運営者が不適切と判断する行為
        ...
        本サービスでは、決済およびクレジットカード情報の管理をStripeに委託しています。コンテンツの購入者はStripeの利用規約に同意したものとみなします。
        本サービスでコンテンツを販売する利用者（以下「販売者」といいます。）は、運営者が表示金額から所定の手数料を徴収することに同意したものとみなします。
        Stripeが徴収する手数料（決済手数料）：表示価格の3.6%
        運営者が徴収する手数料（プラットフォーム利用料）：表示金額から決済手数料を除いた額の10%
        振込手数料：振込申請1回あたり¥350
        ...
        振込先に誤りがあり、組戻し手続きが必要になった場合、楽天銀行の組戻し手数料880円（税込）を振込金額から徴収させていただきます。
        第8条（購入済コンテンツの編集と削除）
